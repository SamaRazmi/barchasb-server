...
const GermanTypeData = async (categoryId) => {
    try {
        const germanType = await TestType.findOneAndUpdate(
          { name: "آلمانی" },
          {
            categoryId: categoryId,
            name: "آلمانی",
            category: "Language",
            description:"ازمون جامع تعیین سطح زبان آلمانی",
      ...
      console.error("German data failed:", error);
      process.exit(1);
    }
}

module.exports = GermanTypeData;