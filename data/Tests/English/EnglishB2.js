...
const questionsData = [
    ...
    { subject: "Grammar", level: "B2", text: "It is necessary that all documents ___ checked before submission.", options: ["Are", "Be", "Were", "Will be"], correct: 1 }, // Subjunctive
    ...
    { subject: "Grammar", level: "B2", text: "I want to ensure that everyone ___ aware of the new procedures.", options: ["Is", "Was", "Be", "Has been"], correct: 2 }, // Subjunctive/Formal
    { subject: "Grammar", level: "B2", text: "The project is expected to ___ by the end of next month.", options: ["Be completed", "Complete", "Was completed", "Completing"], correct: 0 }, // Passive
...
const EnglishB2Data = async (typeId) => {
    try {
        ...
        console.log(`Successfully imported ${formattedQuestions.length} English B2 questions!`);
    } catch (err) {
