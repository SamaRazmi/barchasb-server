...
router.post(
  ...
  sellerController.createSellerAd,
);
 ...
 *         description: خطای سرور
 */
router.get("/ads/seller", sellerController.getAllSellerAds);
 ...
 *         description: خطای سرور
 */
router.get("/ads/seller/owner/:ownerId", sellerController.getAdsByOwner);
 ...
 *         description: خطای سرور
 */
router.get("/ads/seller/:id", sellerController.getSellerAdById);
...
router.get(
  ...
  sellerController.getSellerAdByOwnerAndId,
);
...
router.put(
  ...
  authenticateToken,
  imagesUpload.array("images", 9),
  sellerController.updateSellerAd,
);
...
router.delete(
  "/ads/seller/:adId",
  authenticateToken,
  sellerController.deleteSellerAd,
);
