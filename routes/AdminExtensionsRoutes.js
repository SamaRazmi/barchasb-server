 ...
 */
router.get('/tests/detailedResult/:sessionId', testController.getTestResultDetail);
 ...
 *         description: Server Error
 */
router.get('/converter-tools/users-tool-usage', converterController.getUsersToolUsage);
/**
 * @swagger
 ...
 *         description: Server Error
 */
router.get('/converter-tools/tool-popularity', converterController.getToolPopularity);
/**
 * @swagger
 ...
 *         description: Server error
 */
router.get('/converter-tools/tool-performance', converterController.getToolPerformance);
