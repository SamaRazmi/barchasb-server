...
const digitalAdSchema = new mongoose.Schema({
  ...
  // ========== فیلدهای جدید هماهنگ با کامپوننت ==========
  // نوع درخواست (درخواست‌دهنده یا ارائه‌دهنده)
  requestType: {
    type: String,
  ...
  // واحد زمانی - دقیقاً مطابق TimeUnit در کامپوننت
  durationUnit: {
    type: String,
  ...
  // مقدار عددی بازه زمانی (مثلاً "20")
  durationAmount: { type: String },
