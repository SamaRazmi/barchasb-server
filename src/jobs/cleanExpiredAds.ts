 ...
 * به همراه تمام وابستگی‌هایشان (چت، گزارش، مارک، ویو، پیشنهادات و ...) حذف می‌کند.
 */
...
async function deleteAdWithDependencies(
  ...
  try {
    await prisma.$transaction(async (tx) => {
      ...
      // ============================================================
      // 7. حذف AdSimilarityScore (شباهت‌ها)
      // ============================================================
      ...
      // ============================================================
      // 8. حذف CachedUserSuggestions (کش پیشنهادات)
      ...
      // ============================================================
      // 9. حذف فایل‌های فیزیکی تصاویر (در صورت ذخیره محلی)
      // ============================================================
      if (adData?.images) {
      ...
      // ============================================================
      // 10. حذف خود آگهی از جدول مربوطه
      // ============================================================
      switch (adType) {
        case "EmployerAd":
