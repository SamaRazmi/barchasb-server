...
const questionsData = [
    ...
    { subject: "Grammar", level: "C2", text: "The team is expected to ___ the project by the end of the current fiscal month.", options: ["Have completed", "Complete", "Will complete", "Completing"], correct: 0 }, // Future Perfect
    { subject: "Grammar", level: "C2", text: "It is essential that all sensitive documentation ___ thoroughly reviewed before submission.", options: ["Be", "Are", "Was", "Have been"], correct: 0 }, // Subjunctive
...
const EnglishC2Data = async (typeId) => {
    try {
        ...
        console.log(`Successfully imported ${formattedQuestions.length} English C2 questions!`);
    } catch (err) {
